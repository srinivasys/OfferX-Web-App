...
import { OptionsOrder } from '../utils/candidate-company-options';

const RateOfferAccepted = () => {
    return (
        <>
            <div className="col-xl-12 col-xxl-12 col-12">
                <div className="card p-4 mb-4 lt-star-review-card grayscale">
                    ...
                    <ReactApexChart options={OptionsOrder} series={[75]} type="radialBar" height={255} />
                </div>
            </div>
        </>
    );
...
export default RateOfferAccepted;
